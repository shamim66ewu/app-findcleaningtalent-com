      ...
      return(
        <View style={styles.container}>
          ...
          <View style={[styles.alignItem,{paddingTop:20}]}>
            <Text style={{color:"#1D568F"}}>Forgot your Password?</Text>

            <View style={styles.SiText}>
            <Checkbox style={styles.checkbox} value={isChecked} onValueChange={setChecked} color="#e5e5e5" />
              <Text style={{color:'#9FA7AC'}}>Keep me logged in</Text>
            </View>
            ...
            <View style={styles.SiText}>
              ...
              <Text style={{color:'#1D568F'}}>Sing up here</Text>
            </View>
          </View>
